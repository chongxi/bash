...
export ZSH=/groups/apig/home/laic/.oh-my-zsh
...
# User configuration
export PATH="/opt/Xilinx/Vivado/2016.1/bin:/opt/Xilinx/Vivado_HLS/2016.1/bin:/usr/local/anaconda2/bin:/usr/local/demoapps:$PATH"
